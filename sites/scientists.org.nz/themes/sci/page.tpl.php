...
<!-- footer_upper starts here -->
 <?php if ($footer_upper): ?>
  <div id="footer-upper">
   <?php print $footer_upper; ?>
  </div>
 <?php endif; ?>
  <!-- footer_upper ends here -->
 ...
 <div id="madeby"><a href="http://www.backspace.co.nz"><img src="/files/bs.jpg"  alt="made by www.backspace.co.nz" title="made by www.backspace.co.nz"/></a>
    </div>
    </div>
    <!-- footer ends here -->
