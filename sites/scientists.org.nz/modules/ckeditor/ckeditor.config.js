...
CKEDITOR.editorConfig = function(config) {
  ...
  * SCI MEMBER BAR
  */
  config.toolbar_Member = [ ['Bold', 'Italic', '-', 'NumberedList','BulletedList', '-', 'Link', 'Unlink', '-', 'DrupalBreak' ] ];
 ...
 // config.extraPlugins += (config.extraPlugins ? ',button-h1' : 'button-h1' ); 
//  CKEDITOR.plugins.addExternal('button-h1', Drupal.settings.ckeditor.module_path + '/plugins/button-h1/');
